...
public class Hilos {
    public void iniciarHilos(String rutaColeccion, Integer cantidadArchivos){
        ...
        /*Preprocesador preprocesador1 = new Preprocesador("1", rutaColeccion, 7990, 8790);
        Preprocesador preprocesador2 = new Preprocesador("2", rutaColeccion, 8790, 9590);
        Preprocesador preprocesador3 = new Preprocesador("3", rutaColeccion, 9590, 10390);
        Preprocesador preprocesador4 = new Preprocesador("4", rutaColeccion, 10390, 11190);
        Preprocesador preprocesador5 = new Preprocesador("5", rutaColeccion, 11190, 11990);
        Preprocesador preprocesador6 = new Preprocesador("6", rutaColeccion, 11990, 12790);
        Preprocesador preprocesador7 = new Preprocesador("7", rutaColeccion, 12790, 13590);
        Preprocesador preprocesador8 = new Preprocesador("8", rutaColeccion, 13590, 14390);
        Preprocesador preprocesador9 = new Preprocesador("9", rutaColeccion, 14390, 15190);
        Preprocesador preprocesador10 = new Preprocesador("10", rutaColeccion, 15190, 15980);*/
