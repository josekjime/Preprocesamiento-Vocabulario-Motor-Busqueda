...
public class Contador {
    ...
    public ConcurrentHashMap<String, Preprocesador.ValoresPalabra> contarApariciones(ConcurrentHashMap<String, Preprocesador.ValoresPalabra> vocabularioGlobal) {
