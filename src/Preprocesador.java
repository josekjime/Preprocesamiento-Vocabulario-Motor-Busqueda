...
public class Preprocesador implements Runnable{
    ...
    private static ConcurrentHashMap<String, ValoresPalabra> vocabularioGlobal; // Key: palabra, Value: cantidad de documentos donde aparece
    ...
    Preprocesador(String nombreHilo, String rutaColeccion, Integer archivoInicial, Integer archivoFinal){
        ...
        this.vocabularioGlobal = new ConcurrentHashMap<>();
    }
